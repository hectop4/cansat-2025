...
#define pin 1                  // Analog input 0 of your arduino
...
void setup()
{
  ...
  MQ135.setA(110.47);
  MQ135.setB(-2.862); // Configure the equation to to calculate NH4 concentration
...
void loop()
{
  ...
  Serial.println(MQ135.readSensor() * 100, 1); // Will print the table on the serial port
  delay(500);                                  // Sampling frequency
}

//! Code for MQ135 in PPM V1
